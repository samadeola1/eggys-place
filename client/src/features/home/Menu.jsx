        ...
        <section className="md:grid md:grid-cols-2 lg:grid-cols-3  justify-items-center gap-10  my-10 ">
          {isLoading ? (
            [...Array(menuItems.length || 6)].map((index) => (
              <div key={index} className="card bg-[#252422] w-full md:w-[340px] lg:w-[98%] p-[16px] my-10 md:my-0 shadow-sm">
              ...
              {menuItems
                ...
                .map((mappedMenu) => {
                  ...
                  return (
                    <div
                      key={_id}
                      className="card bg-[#252422] w-full md:w-[340px] lg:w-[98%]  p-[15px] my-10 md:my-0 shadow-sm"
                    >
                      <Link to={`/product/${_id}`}>
                        <figure>
                          <img
